    ...
    for tag in Top10:
        ...
        for n,ddate in enumerate(date):
            ...
            for x in range(5):                              
                ...
                print(re)
                # re.to_csv(r'D:\Program_code\python\Code_test\stock_gap_NLP\test4.csv')
                ...
                # # tokenized_texts_word.to_csv('D:\Program_code\python\Code_test\stock_gap_NLP\Token\\token_'+f'{tag}_' +f'{date_now}.csv')      
                ...
                # print('tokenized_texts_word.siz:',len(tokenized_texts_word))
                # size=len(tokenized_texts_word)-1
                # tokenized_texts_word=tokenized_texts_word.drop(size)
                # print(tokenized_texts_word)
                # print('tokenized_texts_word.shap',tokenized_texts_word.shape)
                ...
                # size=len(re.close_status)-3
                # re=re.drop(re.tail(3).index,inplace=True)
                re1=re.copy()
                # sizey=len(re1)
                re1=re1[:-1]
                ...
                for  method in li:
                    ...
                    # o=pd.DataFrame.sparse.from_spmatrix(X_data_test_csr)
                    # o.to_csv('D:\Program_code\python\Code_test\stock_gap_NLP\X_data_test_csr.csv')
        ...
        frame4.to_csv('D:\Program_code\python\Code_test\stock_gap_NLP\\result\\'+f'{tag}_pre.csv')
            ...
            #         
                ...
                #         model.fit(x_train, y_train)
                #         #step3:predict
                #         y_pre = model.predict(X_tfidf_pre)
                #         print(X_tfidf_pre.shape)
                #         print('y_pre_test:',y_pre )
                #         print(len(y_pre))